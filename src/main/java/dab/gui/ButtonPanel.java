...
public class ButtonPanel extends JPanel {
	private dab.bigBunny.App.PumpButton  btnPump1, btnPump2;
    private dab.bigBunny.App.ValveButton btnValve1, btnValve2;
	...
	public ButtonPanel(Simulator sim){
		...
		add(pump2_label);
		btnPump2 = new dab.bigBunny.App.PumpButton(sim.getPump(2));
        ...
        add(pump1_label);
		btnPump1 = new dab.bigBunny.App.PumpButton(sim.getPump(1));
        ...
        add(valve2_label);
		btnValve2 = new dab.bigBunny.App.ValveButton(sim.getValve(2));
        ...
        add(valve1_label);
		btnValve1 = new dab.bigBunny.App.ValveButton(sim.getValve(1));
